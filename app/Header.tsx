    ...
    <header className='sticky top-0 z-50 bg-white flex justify-between 
      ...
      <div className="flex space-x-2">
        ...
        <div>
          ...
          <p className='font-bold text-lg'>Łukasz Michalik</p>
        </div>
      </div>
      <LogoutButton />
    </header>
  ...
  return (
    <header className='sticky top-0 z-50 bg-white flex justify-center 
      ...
      <div className='flex flex-col items-center space-y-5'>
        ...
        <Link href="/auth/signin" className='bg-blue-500 hover:bg-blue-700 
        text-white font-bold py-2 px-4 rounded'>Sign In</Link>
      </div>
    </header>
  )
}
